                ...
                <Row>
                    ...
                    <Col s={12} m={12}>
                        ...
                        <form s={6} xs={6} onSubmit={this.handleSubmit}>  
                            ...
                            <Input placeholder="Apartment, suite, unit etc. (optional)" s={6} label="" />
                        ...
                        <Card className='blue-grey darken-1' textClassName='white-text' title='Your order'>
                        ...
                        <Input name='group1' type='radio' value='cash' label='Cash on delivery' className='with-gap' />
                        
                        {/*Pay via PayPal; you can pay with your credit card if you don’t have a PayPal account.*/}
                        <Input name='group1' type='radio' value='paypal' label='PayPal' disabled='disabled' />
